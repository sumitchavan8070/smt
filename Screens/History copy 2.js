...
const History = () => {
  ...
  const getHtml = () => {
    const html = `
          ...
          <head>
            ...
            <style>
              ...
              .box-template {
                border: 1px solid #000;
                padding: 20px;
                margin-top: 120px; /* Adjust to make space for the header */
                margin-bottom: 50px; /* Adjust to make space for the footer */
          ...
          <body class="box-template">
          <div class="header">
          <div>
            <img src="https://i0.wp.com/examtipsindia.com/wp-content/uploads/2022/05/logo.png" alt="Logo" class="logo">
          </div>
          <div class="tagline">
            Your Tagline Here
          </div>
          ...
          <div class="container"> <!-- Added box-template class here -->
          <div class="box-heading">Test Preview</div>
              ...
              ${selectedQuestions
                .map(
                  (question, index) => `
              <div>
                <h3 class="question-text">Question ${index + 1}</h3>
